            ...
            <div class="card-header">
                ...
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    <div class="action-btn">
                        <a href="{{ route('permissions.create') }}" class="btn btn-sm btn-primary btn-add">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table-actions">
                                                ...
                                                <form id="delete-item" class="d-inline" action="{{ route('permissions.destroy', $item->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
