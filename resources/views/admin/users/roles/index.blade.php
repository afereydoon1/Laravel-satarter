                        ...
                        <div class="table-responsive">
                            <table class="table table--default traffic-table" id="myTable">
                                ...
                                <tr>
                                    <th>#id</th>
                                    <th>role-name</th>
                                    <th class="text-center">Add Permission</th>
                                    <th>Action</th>
                                </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="atbd-button-list d-flex flex-wrap align-items-center justify-content-center">
                                                <a href="{{ route('role_has_permission.create', $item->id) }}" class="btn btn-primary btn-xs btn-squared ">
                                                    Add Permission
                                                </a>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="table-actions">
                                                ...
                                                <form id="delete-item" class="d-inline" action="{{ route('roles.destroy', $item->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
