...
use App\Http\Controllers\Admin\Users\{RoleController,PermissionsController,RoleHasPermissionController,ModelHasRoleController,ModelHasPermissionController};
...
Route::prefix('users-management')->group(function () {
    ...
    //customers
    Route::get('customers/status/{user}', [CustomerUserController::class, 'status'])->name('customers.status');
    Route::resource('customers', CustomerUserController::class)->except(['edit','update']);
